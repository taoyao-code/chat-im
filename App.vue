...
export default {
	onLaunch: function() {
		...
		// uni.setStorageSync('WS', 'ws://localhost:8088/index');
		// uni.setStorageSync('URL', 'http://localhost:8088');
		// uni.setStorageSync('ImageURL', 'http://localhost:8088/');
		
		uni.setStorageSync('WS', 'ws://chat.bo5.xyz/index');
